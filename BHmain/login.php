    ...
    <header>
      <nav class="navbar" style="background-color: #11252C;">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="index.html" style="color:white;">Baja</a>
          ...
          <?php if ($login_error) echo "<div class='alert alert-danger'>$login_error</div>"; ?>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="loginPassword" placeholder="Írd ide a jelszavadat..."  name="password" required>
        ...
        <div class="container-fluid d-flex flex-column align-items-center justify-content-center">          
          ...
          <?php if ($success) echo "<div class='alert alert-success'>$success</div>"; ?>
              ...
              <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-2 mb-md-0">
                        <input type="text" class="form-control" id="firstname" placeholder="Keresztnév" name="firstname">
                    </div>
                    <div class="col-12 col-md-6">
                        <input type="text" class="form-control" id="lastname" placeholder="Vezetéknév" name="lastname">
                    </div>
                </div>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="phonenumber" placeholder=" Írd ide a telefonszámod..."  name="phonenumber">
              </div>
   
              <div class="mb-3">
                <label class="form-label">Jelszó</label>
                <div class="input-group">
                    <input type="password" class="form-control" id="registerPassword" name="password" placeholder="Írd ide a jelszavadat..." required>
                    <span class="input-group-text" style="cursor:pointer;"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="confirmPassword" name="confirm" placeholder="Írd még egyszer a jelszavadat..." required>
                    <span class="input-group-text" style="cursor:pointer;"
        ...
        <div class="container-fluid" id="footer-content">
          <div class="row">  
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4" id="footer-oszlop2">
              <h5>Elhelyezkedés</h5>
              <a href="terkep.html" id="Terkep_link"><p>Térkép oldal megnyitása</p></a>
